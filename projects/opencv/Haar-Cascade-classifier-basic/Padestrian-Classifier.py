...
body_classifier_path = r'D:\GIT_HUB\fullStackDatascience\projects\opencv\Haar-Cascade-classifier-basic\haarcascade_fullbody.xml'
...
video_path = r'D:\GIT_HUB\fullStackDatascience\projects\opencv\Haar-Cascade-classifier-basic\15017584_2160_3840_30fps.mp4'
...
while cap.isOpened():
    ...
    if cv2.waitKey(25) & 0xFF == 13:  # 13 corresponds to the Enter key
        print("Exiting...")
        break
    # Removed time.sleep(0.1) as it interferes with video playback frame pacing and cap.read() timing
