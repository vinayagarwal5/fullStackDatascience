# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 10:14:35 2026
...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 09:51:23 2026
...
dataset = pd.read_csv(r"C:\Users\vinay agrawal\FSDS_PROJECT\20th- knn\20th- knn\Social_Network_Ads.csv")
...
#classifier = DecisionTreeClassifier(criterion='entropy',splitter='random',max_depth=10,random_state=0)
classifier = RandomForestClassifier(criterion='entropy',n_estimators=30,max_depth=4,random_state=0)
